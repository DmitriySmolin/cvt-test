  ...
  return (
    <header className="header row align-items-center mt-3 ">
      ...
      <div className="col-lg-5 col-md-4 col-sm-12 d-flex flex-md-row justify-content-lg-end flex-column align-items-center  gap-3">
        ...
        {props.isAuth
          ? <NavLink to="/logout"><Button type="outline-dark" width="header-button-logout">Выйти</Button></NavLink>
          : <NavLink to="/auth"><Button type="dark" width="header-button-login">Войти</Button></NavLink>}
      </div>
    </header>
