    ...
    return <React.Fragment>
      <Modal>
        <form className="register-form" onSubmit={this.submitHandler}>
          ...
          {this.renderInputs()}
          <Button type="dark" onClick={this.registerHandler}>Зарегистрировать</Button>
          {this.props.error?.message && <span className="error-message d-flex justify-content-center">{this.props.error.message}</span>}
          {this.props.success && <span className="success-message d-flex justify-content-center">Вы успешно зарегистрировались!</span>}
        </form>
      </Modal>
    </React.Fragment>;
